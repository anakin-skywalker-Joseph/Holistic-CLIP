...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        type=str,
        default="patch",
        help="For csv-like datasets, the name of the key for the patchs."
    )
    parser.add_argument(
        "--imagenet-val",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to imagene-r val set for conducting zero shot evaluation.",
    )
    parser.add_argument(
        "--imagenet-a",
        type=str,
        default=None,
        help="Path to imagenet-a val set for conducting zero shot evaluation.",
    )
    parser.add_argument(
        "--logs",
        type=str,
