...
from .loss_modify import ClipLoss, DistillClipLoss, CoCaLoss
...
from .zero_shot_metadata import OPENAI_IMAGENET_TEMPLATES, SIMPLE_IMAGENET_TEMPLATES, IMAGENET_CLASSNAMES, IMAGENET_R_CLASSNAMES, IMAGENET_A_CLASSNAMES
