...
from .model import CLIP, CustomTextCLIP, convert_weights_to_lp, convert_to_custom_text_state_dict,\
    ...
    PatchCLIP
from .model.coca_model import CoCa
from .loss_modify import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss
...
def create_model(
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if custom_text:
            ...
            model = CLIP(**model_cfg, cast_dtype=cast_dtype, moe_head = moe_head, moe_layer = moe_layer)
        ...
        if precision in ("fp16", "bf16"):
            ...
            if is_timm_model:
                ...
                from .model.transformer import LayerNormFp32
        ...
        if pretrained:
            ...
            if pretrained_cfg:
                # HACK The network is fucked up, so i have to download manually and appoint the checkpoint path
                # this is to hacky and i hate it
...
def create_loss(args, moe_head = 3):
    if args.distill:
