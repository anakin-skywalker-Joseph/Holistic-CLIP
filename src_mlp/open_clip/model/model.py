...
class CLIP(nn.Module):
    ...
    def __init__(
        ...
        self.input_dtype = get_input_dtype(args.precision)
    ...
    def encode_image_feature_map(self, image, normalize: bool = False):
        features = self.visual.compute_feature_map(image)
